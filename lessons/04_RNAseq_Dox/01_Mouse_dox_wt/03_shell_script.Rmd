...
#!/bin/bash
#SBATCH -p short
#SBATCH --job-name=OMG HAIII
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=kihi8563@colorado.edu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=6gb
#SBATCH --time=10:00:00
...
-profile singularity \
--input samplesheet.csv \
--outdir /scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/kihihihi/MASTER_CLASS/lessons/04_RNAseq_Dox/01_Mouse_dox_wt/dox_long/dox_long_output \
--reads /scratch/Shares/rinnclass/MASTER_CLASS/DATA/mouse_wt_long_timecourse*{_R1,_R2}.fastq.gz \
--fasta /scratch/Shares/rinnclass/MASTER_CLASS/GENOMES/M25/GRCm38.p6.genome.fa \
--gtf /scratch/Shares/rinnclass/MASTER_CLASS/GENOMES/M25/gencode.vM25.annotation.gtf \
--pseudo_aligner salmon \
--gencode \
--email kihi8563@colorado.edu \
-c nextflow.config
